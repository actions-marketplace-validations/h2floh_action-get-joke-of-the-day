...
var legacy_1 = __importDefault(__webpack_require__(216));
var utils_functions_1 = __webpack_require__(794);
var utils_functions_2 = __webpack_require__(794);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.getJokeOfTheDay = exports.run = void 0;
const core = __importStar(__webpack_require__(470));
const http_status_codes_1 = __webpack_require__(9);
const rm = __importStar(__webpack_require__(105));
/**
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield getJokeOfTheDay(jokesOneApiKey);
        }
        catch (error) {
 ...
 */
function getJokeOfTheDay(apiKey) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const restClient = new rm.RestClient('github-action-get-joke-of-the-day', 'https://api.jokes.one');
        const requestOptions = { acceptHeader: 'application/json' };
        if (apiKey !== 'none') {
            requestOptions.additionalHeaders = { 'X-JokesOne-Api-Secret': apiKey };
        }
        const response = yield restClient.get('/jod', requestOptions);
        if (response.statusCode === http_status_codes_1.StatusCodes.OK) {
            const joke = (_a = response.result) === null || _a === void 0 ? void 0 : _a.contents.jokes[0].joke.text;
...
exports.getJokeOfTheDay = getJokeOfTheDay;
...
Object.defineProperty(exports, "__esModule", { value: true });
const get_joke_1 = __webpack_require__(191);
(0, get_joke_1.run)();
...
var GetIntrinsic = __webpack_require__(116);
...
var utils_1 = __webpack_require__(350);
/**
